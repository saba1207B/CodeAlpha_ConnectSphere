...
export const ParticipantsDrawer: React.FC<ParticipantsDrawerProps> = ({
  ...
  return (
    <div className="fixed sm:absolute top-14 bottom-18 sm:bottom-20 right-0 w-full sm:w-80 z-40 bg-[#1e2026] border-l border-[#2e323e] shadow-2xl flex flex-col transition-all duration-200 select-none text-zinc-200">
      {/* Header */}
